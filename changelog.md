...
## 2026-07-12
- Added media-sync cluster (syncthing, filebrowser, syncplay) for cross-node file replication and synchronized co-viewing between nat-server and kostyan-server
